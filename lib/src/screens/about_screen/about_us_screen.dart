      ...
      children: [
        ...
        Padding(
          ...
          child: Center(child: Column(
            children: const [
              Text('Homes',style: TextStyle(fontFamily: 'Lexend',
                fontSize: 48,
                fontWeight: FontWeight.w700
              ),),
              Text('Smart way to live',style: TextStyle(
                  fontSize: 24,
                  fontFamily: 'Lexend',
        ...
        ListTile(
          ...
          subtitle: const Text('Hridyen Prashar',
          style: TextStyle(
            fontSize: 14,
            fontFamily: 'Lexend',
            fontWeight: FontWeight.w300
        ...
        ListTile(
          ...
          subtitle: const Text('Make your house a HOME',
            style: TextStyle(
                fontSize: 14,
              fontFamily: 'Lexend',
            ),),
